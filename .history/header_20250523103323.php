...
<nav id="menu-items-mobile"
     class="fixed top-0 left-0 z-50 w-full h-screen bg-white overflow-y-auto flex flex-col gap-4 text-lg font-semibold uppercase text-[var(--main-color)] transition-all duration-300 ease-in-out -top-full">
  <?php
    wp_nav_menu([
      'theme_location' => 'primary',
      'container' => false,
