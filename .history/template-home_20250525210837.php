...
<section class="relative z-10">
    ...
    <div class="flex flex-col items-center justify-centerbg-black-600 text-[var(--main-color)] p-8 rounded-xl text-center gap-4 md:w-3/4 mx-auto pt-32 md:pt-64" id="aboutus">
