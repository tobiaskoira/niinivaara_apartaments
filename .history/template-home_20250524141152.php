...
<section class="relative overflow-hidden">
    <div class="absolute top-0 left-0 w-full z-10">
      ...
      <div class="">
        <svg class="block " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#C49367ff" fill-opacity="1" d="M0,128L80,112C160,96,320,64,480,69.3C640,75,800,117,960,128C1120,139,1280,117,1360,106.7L1440,96L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
    </div>
