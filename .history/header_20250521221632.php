...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="Site Logo" class="h-16 w-32 object-contain sm:h-20 sm:w-40 md:h-24 md:w-48 lg:h-32 lg:w-64 xl:h-40 xl:w-80">
