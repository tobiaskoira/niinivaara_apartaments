<div class="w-full leading-[0] -mb-1 -mt-16">
  <svg xmlns="http://www.w3.org/2000/svg"
       viewBox="0 0 1440 320"
       >
    <path fill="#9C674Aff" fill-opacity="1"
          d="M0,256L40,234.7C80,213,160,171,240,165.3C320,160,400,192,480,213.3C560,235,640,245,720,234.7C800,224,880,192,960,192C1040,192,1120,224,1200,234.7C1280,245,1360,235,1400,229.3L1440,224L1440,320L0,320Z">
    </path>
  </svg>

</div><footer class="bg-[var(--background-dark)] text-white py-10 px-8">
    
  <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">

    <!-- Left: Contact form -->
    <div class="md:w-1/2" id="contactme">
      <h2 class="text-4xl 2xl:text-5xl font-semibold mb-6 hover:text-[var(--text-hover)] px-2 py-1 rounded" >Ota yhteyttä</h2>
