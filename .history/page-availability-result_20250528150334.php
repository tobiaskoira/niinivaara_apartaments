...
if ($arrival && $departure) {
    ...
    $end = new DateTime($departure);    // Save formatted strings BEFORE the loop modifies the object
...
if ($isAvailable) {
    echo '<h2 class="text-2xl font-bold text-[var(--main-color)]">Huoneisto on saatavilla ajalla $start to $end!</h2>';
