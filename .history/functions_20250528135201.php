...
<div class="max-w-md mx-auto  text-white rounded-xl p-6 mt-6">
  ...
  <form method="GET" action="/availability-result" class="space-y-4">
    <div class=" flex flex-wrap gap-4items-center justify-center">
      <input type="date" id="arrival"  name="arrival" class="w-full px-4 py-2 rounded text-black" required>
      <input type="date" id="departure" name="departure" class="w-full px-4 py-2 rounded text-black" required>
   
      <select id="adults" name="adults" class="w-full px-4 py-2 rounded text-black">
      ...
      <select id="children" name="children" class="w-full px-4 py-2 rounded text-black">
