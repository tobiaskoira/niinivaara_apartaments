<footer class="bg-[var(--background-dark)] text-white py-10 px-8 rounded">
  ...
  <button id="scrollToTopBtn" class="fixed bottom-8 left-8 p-4 bg-[var(--button-background)] text-white rounded-full shadow-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
    ↑
  </button>
</footer>
