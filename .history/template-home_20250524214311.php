...
<section class="relative z-10">
  ...
  <!-- Заголовок НА волне -->
  <div class="absolute -top-3 sm:top-1  left-1/2 transform -translate-x-1/2 z-20 ">
    <h1 class="text-3xl font-bold text-center text-[var(--main-light)]">
      Meidän huoneet
    </h1>
  </div>
    </div>
...
<section class="relative overflow-hidden -mt-1">
    ...
    <div class="px-4 -mt-6">
<h1 class="text-3xl font-bold text-center text-[var(--main-color)] mb-6">Olemme täällä</h1>
