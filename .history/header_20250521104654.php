...
<header class="relative w-full h-[500px]">
  ...
  <!-- Навигация -->
  <nav class="absolute left-1/2 -translate-x-1/2 w-1/3 md:w-full p-6 md:p-4 z-20 flex items-center justify-center rounded   bg-white bg-opacity-40  text-black">
