  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="w-full h-[100px] block">
    <defs>
      <linearGradient id="waveGradient" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="#6B3E2E" />
        <stop offset="100%" stop-color="#3B2218" />
      </linearGradient>
    </defs>
    <path fill="url(#waveGradient)" fill-opacity="1" d="M0,256L40,234.7C80,213,160,171,240,165.3C320,160,400,192,480,213.3C560,235,640,245,720,234.7C800,224,880,192,960,192C1040,192,1120,224,1200,234.7C1280,245,1360,235,1400,229.3L1440,224L1440,320L0,320Z"></path>
  </svg>
</div>
