<footer class="bg-[var(--background-dark)] text-white py-10 px-8 rounded">
    <svg viewBox="0 0 1440 100" style="position:absolute; bottom:0; left:0; width:100%; height:100px;" preserveAspectRatio="none">
    <path d="M0,30 C360,100 1080,0 1440,30 L1440,100 L0,100 Z" fill="#ffffff"></path>
  </svg>
