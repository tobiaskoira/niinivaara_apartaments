...
function my_theme_scripts() {
    ...
    wp_enqueue_script('full-calendar', get_template_directory_uri() . '/assets/js/fullCalendar.js', array(), null, true);
}
...
add_action('wp_enqueue_scripts', function () {
    ...
    // ical.js must be enqueued BEFORE your custom script
    ...
    wp_enqueue_script('google-calendar-script', get_template_directory_uri() . '/assets/js/fullCalendar.js', ['ical-js', 'fullcalendar-js'], null, true);
});
