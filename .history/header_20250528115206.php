...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/header.jpg"
  ...
  <!-- Regular Menu -->
  <nav class="sm:flex-1 sm:flex sm:justify-center hidden text-[var(--main-color)] xl:text-[var(--main-color)] " id="menu-items">
    <?php
      wp_nav_menu([
        'theme_location' => 'primary',
        'container' => false,
        'menu_class' => 'flex gap-6 text-base md:text-lg lg:text-xl xl:text-3xl font-semibold uppercase  text-[var(--main-color)]',
