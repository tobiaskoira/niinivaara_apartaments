...
<a href="<?php echo esc_url(home_url('/')); ?>" class="inline-block">
  ...
  <!-- Center Menu -->
  <nav class="sm:flex-1 sm:flex sm:justify-center hidden absolute top-0 left-0 w-full bg-white bg-opacity-40 transition-all duration-500 ease-in-out" id="menu-items">
    <?php
      wp_nav_menu([
