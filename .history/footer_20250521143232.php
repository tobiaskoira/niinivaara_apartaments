  ...
  <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
    ...
    <div class="md:w-1/2">
      ...
      <form class="space-y-4">
        ...
        <button
          type="submit"
          class="bg-[var(--button-background)] hover:bg-[var(--button-background-hover)]blue-700 text-white font-semibold px-6 py-2 rounded-md"
        >
          Send
        </button>
      </form>
