...
if ($apartments->have_posts()):
    echo '<div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">'; <!-- Ограничиваем ширину контейнера -->
    while ($apartments->have_posts()): $apartments->the_post();
        ?>
        <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden my-8"> <!-- Ограничиваем ширину для каждой карточки -->
