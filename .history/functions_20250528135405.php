...
<div class="max-w-md mx-auto  text-white rounded-xl p-6 mt-6">
  ...
  <form method="GET" action="/availability-result" class="space-y-4">
    ...
    <button type="submit" class=<form method="GET" action="/availability-result" class="space-y-4">
  <div class="flex flex-wrap gap-4 items-center justify-center">
    <input type="date" id="arrival" name="arrival" class="flex-1 min-w-[150px] px-4 py-2 rounded text-black" required>
    <input type="date" id="departure" name="departure" class="flex-1 min-w-[150px] px-4 py-2 rounded text-black" required>
...
"bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded w-full">
      Tarkista saatavuus
    </button>  
