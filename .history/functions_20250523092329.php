...
add_action('wp_head', function () {
    echo '<link href="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/main.min.css" rel="stylesheet">';
    echo '<script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/main.min.js"></script>';
}, 5); // делаем до всего
