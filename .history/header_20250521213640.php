...
<header class="relative w-full h-[500px] mb-4">
  ...
  <!-- Навигация -->
  <nav class="absolute left-1/2 -translate-x-1/2 max-w-md w-3/4 p-6  z-20 flex items-center justify-center rounded   bg-white bg-opacity-40  text-[var(--main-color)]">
