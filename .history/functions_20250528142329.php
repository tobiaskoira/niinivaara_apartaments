...
<div class="max-w-md mx-auto  text-white rounded-xl p-6 mt-6">
  ...
  <form method="GET" action="{$action_url" class="space-y-4">
    ...
    <button type="submit" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded flex-1 min-w-[150px]">
      Tarkista saatavuus
    </button>  
