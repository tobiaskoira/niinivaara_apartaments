...
<section class="relative z-10">
  ...
  <div class="absolute bottom-10 sm:bottom-0 left-1/2 transform -translate-x-1/2 z-20 text-center">
    <h1 class="text-4xl font-bold text-[var(--main-light)]">
      Meidän huoneet
    </h1>
  </div>
    </div>
...
<!-- Map section pulled up using only -mt -->
<div class="px-4 -mt-16">
  <h1 class="text-4xl font-bold text-center text-[var(--main-color)] mb-6">Olemme täällä</h1>
