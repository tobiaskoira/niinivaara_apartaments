...
<section class="relative z-10">
    ...
    <h1 class="text-4xl font-bold">Tervetuloa majoitumaan Niinivaran Apartments!</h1>
        <p class="mt-4 text-xl">Niinivaara apartment saunallinen ja ilmastoitu majoitus sijaitsee Joensuussa. Käytettävissä on sauna. Hiljattain kunnostetussa majoituspaikassa on yksityinen pysäköintialue. Käytettävissä on sauna, ja aivan vieressä on lähikauppa. Lähin lentoasema on 11 km:n päässä sijaitseva Joensuun lentoasema.</p>
