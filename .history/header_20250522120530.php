...
<a href="<?php echo esc_url(home_url('/')); ?>" class="inline-block">
  ...
  <div class="flex items-center justify-center pt-32">
    <div class="text-[var(--main-color)] text-center p-6 rounded">
      <h1 class="text-4xl md:text-5xl text-[var(--main-light)] font-bold drop-shadow-sm">Varaa huoneistot</h1>
    <h1 class="text-4xl md:text-5xl text-[var(--main-light)] ">Varaa huoneistot</h1>
