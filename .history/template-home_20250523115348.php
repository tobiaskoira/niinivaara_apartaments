...
<div class="md:w-3/4 mx-auto bg-[var(--background-light)] rounded p-6 mb-1 md:mb-4">
    <?php
echo do_shortcode('[envira-gallery id="49"]');<!-- <iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=Europe%2FHelsinki&showPrint=0&showTz=0&showTabs=0&showTitle=0&title=Varauskalenteri&src=bDE2NTV2ZG9pZzgwcjJrNTVwYjIyYjVpajhxajZpdGhAaW1wb3J0LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23E4C441" style="border-width:0" width="800" height="600" frameborder="0" scrolling="no"></iframe> -->
