...
<section class="relative z-10">
    ...
    <div class="bg-black-600 text-[var(--main-color)] p-8 rounded-xl text-center gap-4 md:w-3/4 mx-auto pt-40 md:pt-80" id="aboutus">
<?php  echo do_shortcode('[calendar_booking_form]');  ?> 
    ...
    <?php
        ...
        if ($apartments->have_posts()):
            echo '<div class="w-full grid grid-cols-1 md:grid-cols-2 gap-10 mt-10 ">            '; 
