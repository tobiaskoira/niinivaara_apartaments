...
<!-- Bottom wave under header with gradient -->
<div class="w-full overflow-hidden leading-[0] -mt-1">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="w-full h-[100px] block">
    <defs>
      <linearGradient id="customWaveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stop-color="rgba(66, 40, 37, 1)" />
        <stop offset="50%" stop-color="rgba(57, 34, 34, 1)" />
        <stop offset="100%" stop-color="rgba(196, 147, 103, 1)" />
      </linearGradient>
    </defs>
    <path fill="url(#customWaveGradient)" fill-opacity="1"
