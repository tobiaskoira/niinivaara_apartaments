<?php get_header(); ?><div class="bg-blue-600 text-white p-8 rounded-xl text-center">
...
<div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl my-8">
  <div class="md:flex">
    ...
    <div class="p-6">
      ...
      <p class="mt-2 text-gray-500">Уютная квартира с кухней и бесплатным Wi-Fi. Идеальна для путешественников.</p>
