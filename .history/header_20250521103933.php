...
<header class="relative w-full h-[500px]">
  ...
  <!-- Навигация -->
  <nav class="absolute left-1/2 -translate-x-1/2 md:w-1/2 p-4 md:p-6 z-20 flex flex-wrap justify-center items-center rounded bg-white bg-opacity-40 text-black">
