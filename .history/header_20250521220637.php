...
<header class="relative w-full h-[500px] mb-4">
  ...
  <!-- Logo (Left) -->
  <a href="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" class="text-xl font-bold"></a>
<a href="<?php echo esc_url(home_url('/')); ?>" class="inline-block">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="Site Logo" class="h-8 w-auto">
</a>
  <!-- Center Menu -->
